...
def export_uncertainty(predicted_list: List[Union[np.ndarray, torch.Tensor]] , properties_dict: dict,
                                  configuration_manager: ConfigurationManager,
                                  plans_manager: PlansManager,
    ...
    # Collect prob results
    prob_list = []
    for count, predicted_array_or_file in enumerate(predicted_list):
        ...
        if save_probabilities:
            # probabilities_final shape: C,D,H,W
            segmentation_final, probabilities_final = ret
            prob_list.append(probabilities_final)
            del ret
